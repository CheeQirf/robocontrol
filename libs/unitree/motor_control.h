...
#define RS485_Pin GPIO_PIN_15

#define SET_485_UP() HAL_GPIO_WritePin(RS485_GPIO_Port, RS485_Pin, GPIO_PIN_SET)
#define SET_485_DOWN() HAL_GPIO_WritePin(RS485_GPIO_Port, RS485_Pin, GPIO_PIN_RESET)
